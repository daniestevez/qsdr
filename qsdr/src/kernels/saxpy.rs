    ...
    pub fn run_znver3(&self, buf: &mut [f32]) {
        ...
        unsafe {
            std::arch::asm!(
                ".align 16",
                "2:",
                "vmulps {y0}, {vA}, ymmword ptr [{buff_end} + {offset:r}]",
                "vmulps {y1}, {vA}, ymmword ptr [{buff_end} + {offset:r} + 32]",
                "vmulps {y2}, {vA}, ymmword ptr [{buff_end} + {offset:r} + 64]",
                "vmulps {y3}, {vA}, ymmword ptr [{buff_end} + {offset:r} + 96]",
                "vaddps {y0}, {y0}, {vB}",
                "vaddps {y1}, {y1}, {vB}",
                "vaddps {y2}, {y2}, {vB}",
                "vaddps {y3}, {y3}, {vB}",
                "vmovaps ymmword ptr [{buff_end} + {offset:r}], {y0}",
                "vmovaps ymmword ptr [{buff_end} + {offset:r} + 32], {y1}",
                "vmovaps ymmword ptr [{buff_end} + {offset:r} + 64], {y2}",
                "vmovaps ymmword ptr [{buff_end} + {offset:r} + 96], {y3}",
                "add {offset:r}, 128",
                "jne 2b",
                buff_end = in(reg) buf.as_mut_ptr().add(buf.len()),
                offset = inout(reg) -(std::mem::size_of_val(buf) as isize) => _,
